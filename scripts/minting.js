...
async function main() {
	...
	console.log("Staking Contract balance: ", stakingContractBalance.div(oneTokenVal), " tokens")
	...
	console.log("Staker1 balance: ", staker1Balance.div(oneTokenVal), " tokens")
	...
	console.log("Staker2 balance: ", staker2Balance.div(oneTokenVal), " tokens")
	...
	console.log("Staker3 balance: ", staker3Balance.div(oneTokenVal), " tokens")
}
